...
object KafkaElastic {
  ...
  def main(args: Array[String]) {
    ...
    val kafkaTopics = "testkafka"    // command separated list of topics
    val kafkaBrokers = "192.168.1.111:6667"   // comma separated list of broker:host
    val batchIntervalSeconds = 2
    val checkpointDir = "/home/zamni/testKafka/" //create a checkpoint directory to periodically persist the data
